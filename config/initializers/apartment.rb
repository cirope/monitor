...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w(Account Database Membership Property PublicVersion ActiveRecord::SessionStore::Session)
  ...
  # end
  #
  config.tenant_names = -> { Account.pluck 'tenant_name' }
...
Rails.application.config.middleware.use SessionElevator
