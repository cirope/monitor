...
class EndpointsTest < ApplicationSystemTestCase
  ...
  test "should create endpoint" do
    ...
    fill_in "Account", with: @endpoint.account_id
    fill_in "Name", with: @endpoint.name
    fill_in "Options", with: @endpoint.options
    fill_in "Provider", with: @endpoint.provider
    fill_in "Session", with: @endpoint.session
